...
export const POSTS: PostSeed[] = [
  {
    ...
    seo_title: "Planejamento tributário no agronegócio em 2025 | SEMA Advogados",
    seo_description: "Entenda como estruturar a carga fiscal da sua operação rural com segurança jurídica. Orientações do escritório SEMA.",
  ...
  },
  {
    ...
    seo_title: "Como reduzir passivos trabalhistas na sua empresa | SEMA Advogados",
    seo_description: "Identifique e mitigue riscos trabalhistas com uma abordagem preventiva. Assessoria especializada do escritório SEMA.",
  ...
  },
  {
    ...
    seo_title: "Holding familiar: vantagens e cuidados | SEMA Advogados",
...
export const NEWS: NewsSeed[] = [
  {
    title: "SEMA participa do Fórum Jurídico do Agronegócio no Piauí",
    slug: "sema-forum-juridico-agronegocio-piaui",
    content: `O escritório Salha Escórcio Mendes Advogados marcou presença no Fórum Jurídico do Agronegócio em Teresina. O evento reuniu produtores rurais, representantes do setor público e profissionais do Direito para debater os impactos da Reforma Tributária e os desafios do compliance ambiental no campo.\n\nA equipe do SEMA apresentou painel sobre planejamento tributário para o agronegócio, com destaque para oportunidades e riscos trazidos pela regulamentação do IBS e da CBS.`,
    location: "Teresina, PI",
    published: true,
    featured: true,
    published_at: "2025-05-15T10:00:00Z",
    seo_title: "SEMA no Fórum Jurídico do Agronegócio no Piauí | Notícias",
    seo_description: "O escritório SEMA participou do Fórum Jurídico do Agronegócio em Teresina, apresentando painel sobre planejamento tributário.",
  ...
  },
  {
    ...
    content: `A implementação gradual da Reforma Tributária traz mudanças relevantes para empresas sediadas no Maranhão, especialmente as que operam com benefícios fiscais estaduais de ICMS.\n\nCom a criação do IBS e da CBS, os benefícios de ICMS dos estados serão gradualmente substituídos. O SEMA recomenda que empresas dependentes de incentivos estaduais realizem diagnóstico técnico nos próximos meses.`,
    location: "São Luís, MA",
    published: true,
    featured: false,
    published_at: "2025-04-28T10:00:00Z",
    seo_title: "Reforma Tributária: impactos para empresas do Maranhão | SEMA",
...
export const EVENTS: EventSeed[] = [
  {
    ...
    description: `O SEMA promoveu workshop fechado sobre compliance trabalhista voltado a gestores de RH e sócios de empresas do agronegócio no Piauí.\n\nForam abordados contratos de safra, trabalho rural intermitente, controle de jornada, terceirização e auditoria preventiva. Os participantes receberam checklist de conformidade adaptado às operações agrícolas e pecuárias da região.`,
    event_date: "2025-06-05T09:00:00Z",
    location: "Teresina, PI",
    participants: "Sócios do SEMA e consultores especializados",
    theme: "Compliance Trabalhista",
    published: true,
    featured: true,
    seo_title: "Workshop Compliance Trabalhista Agronegócio | SEMA Advogados",
    seo_description: "Workshop sobre compliance trabalhista para empresas do agronegócio no Piauí, promovido pelo escritório SEMA.",
